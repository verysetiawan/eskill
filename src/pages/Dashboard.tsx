                                 ...
                                 <div className="bg-white shadow-2xl relative overflow-hidden font-sans text-black w-full max-w-[620px] aspect-[1/1.414] shrink-0 px-[7%] pt-[6%] pb-[4.5%] leading-tight">
                                   ...
                                   <div className="grid grid-cols-2 gap-x-16 gap-y-3 mt-2 text-[8px] font-bold">
                                     <div className="text-center">
                                       ...
                                       <div className="h-[58px] flex items-start justify-center -mt-0.5">
                                         {(isLSPPreview ? settings.school.certificationManagerSignature : department?.competencyHeadSignature) && (
                                           <img src={isLSPPreview ? settings.school.certificationManagerSignature : department?.competencyHeadSignature} className="max-h-[58px] max-w-[180px] object-contain" />
                                         )}
                                       </div>
                                     ...
                                     <div className="text-center">
                                       ...
                                       <div className="h-[58px] flex items-start justify-center -mt-0.5">
                                         {examiner?.signature && <img src={examiner.signature} className="max-h-[58px] max-w-[180px] object-contain" />}
                                       </div>
                                     ...
                                     <div className="text-center pt-5">
                                       ...
                                       <p>Kepala Sekolah</p>
                                       <div className="h-[58px] flex items-start justify-center -mt-0.5">
                                         {settings.school.signatorySignature && <img src={settings.school.signatorySignature} className="max-h-[58px] max-w-[180px] object-contain" />}
                                       </div>
                                     ...
                                     <div className="text-center pt-5">
                                       ...
                                       <div className="h-[58px] flex items-start justify-center -mt-0.5">
                                         {(isLSPPreview ? settings.school.lspDirectorSignature : settings.school.vicePrincipalCurriculumSignature) && (
                                           <img src={isLSPPreview ? settings.school.lspDirectorSignature : settings.school.vicePrincipalCurriculumSignature} className="max-h-[58px] max-w-[180px] object-contain" />
                                         )}
                                       </div>
